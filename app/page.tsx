    ...
    <div id="inicio" className="">
      ...
      <main className="dark:bg-[#333] pb-20 dark:fadeIn dark:transition-all dark:duration-100">
        ...
        <section className="border-2  bg-sky-400 dark:border-dark1 dark:bg-[hsl(36,100%,50%)] rounded-xl mt-30 flex justify-center mx-auto w-[60vw] max-md:w-[95vw] shadow-2xs">
          <div className=" flex flex-col justify-center items-center py-16 lg:w-120">
            ...
            <div className="flex items-center gap-3 max-md:flex-col max-md:gap-0">
              <Link
                href="/personalizar"
                className="flex gap-4 mt-8 bg-dark1 lg:justify-between lg:w-65 dark:bg-dark1 items-center text-white dark:text-[hsl(36,100%,50%)] font-bold rounded-2xl p-4 max-md:p-3 max-md:py-2 shadow-md hover:opacity-90"
                onClick={topCero}
              >
              ...
              <Link
                href="/productos"
                className="flex gap-4 mt-8 max-md:mt-2 lg:justify-between lg:w-68 items-center bg-dark1 dark:bg-dark1 text-white dark:text-[hsl(36,100%,50%)] font-bold rounded-2xl p-4 max-md:p-3 max-md:py-2 shadow-md hover:opacity-90"
              >
